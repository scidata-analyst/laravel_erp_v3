...
<head>
  ...
  <title>User Management — NEXUS ERP</title>
...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">User Management</span>
  </div>
...
<div class="erp-card">
  <div class="table-toolbar">
    ...
    <select class="erp-form-control" style="width:130px"><option>All Roles</option><option>Admin</option><option>Manager</option><option>Staff</option></select>
    <select class="erp-form-control" style="width:130px"><option>All Status</option><option>Active</option><option>Inactive</option></select>
  </div>
  <div class="erp-table-wrap">
    <table class="erp-table" id="tbl-users">
      ...
      <tbody>
        <tr><td>001</td><td><div class="d-flex align-items-center gap-2"><div class="avatar-sm" style="background:linear-gradient(135deg,var(--accent),var(--accent-5))">AK</div>Adam Khan</div></td><td>adam@nexus.com</td><td><span class="badge-status badge-purple">Admin</span></td><td>IT</td><td><span class="badge-status badge-active">Active</span></td><td>Today 10:22</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalUser" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="User" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
        <tr><td>002</td><td><div class="d-flex align-items-center gap-2"><div class="avatar-sm" style="background:linear-gradient(135deg,var(--accent-2),#007a60)">SL</div>Sara Lee</div></td><td>sara@nexus.com</td><td><span class="badge-status badge-info">Manager</span></td><td>Sales</td><td><span class="badge-status badge-active">Active</span></td><td>Today 09:14</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalUser" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="User" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
        <tr><td>003</td><td><div class="d-flex align-items-center gap-2"><div class="avatar-sm" style="background:linear-gradient(135deg,var(--accent-4),#b07a00)">JR</div>James R.</div></td><td>james@nexus.com</td><td><span class="badge-status badge-pending">Staff</span></td><td>Warehouse</td><td><span class="badge-status badge-inactive">Inactive</span></td><td>2 days ago</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalUser" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="User" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
        <tr><td>004</td><td><div class="d-flex align-items-center gap-2"><div class="avatar-sm" style="background:linear-gradient(135deg,var(--accent-3),#b00000)">MP</div>Maya P.</div></td><td>maya@nexus.com</td><td><span class="badge-status badge-info">Manager</span></td><td>Finance</td><td><span class="badge-status badge-active">Active</span></td><td>Yesterday</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalUser" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="User" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
      </tbody>
    </table>
  </div>
...
<div class="row g-3"><div class="col-md-6"><label class="erp-form-label">Full Name</label><input class="erp-form-control" type="text" placeholder="John Smith"/></div><div class="col-md-6"><label class="erp-form-label">Email</label><input class="erp-form-control" type="email" placeholder="john@company.com"/></div><div class="col-md-6"><label class="erp-form-label">Role</label><select class="erp-form-control"><option>Admin</option><option>Manager</option><option>Staff</option><option>Viewer</option></select></div><div class="col-md-6"><label class="erp-form-label">Department</label><select class="erp-form-control"><option>IT</option><option>Sales</option><option>Finance</option><option>HR</option><option>Warehouse</option></select></div><div class="col-md-6"><label class="erp-form-label">Password</label><input class="erp-form-control" type="password" placeholder="••••••••"/></div><div class="col-md-6"><label class="erp-form-label">Status</label><select class="erp-form-control"><option>Active</option><option>Inactive</option></select></div></div>
      </div>
