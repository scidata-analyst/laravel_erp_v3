...
<div class="row g-3">
  <div class="col-md-4">
    <div class="erp-card">
      ...
      <div class="stat-row" style="cursor:pointer;padding:10px 8px"><div class="stat-row-label"><i class="bi bi-shield-fill-check text-accent me-2"></i>Admin</div><span class="badge-status badge-purple">3 users</span></div>
      <div class="stat-row" style="cursor:pointer;padding:10px 8px"><div class="stat-row-label"><i class="bi bi-person-badge me-2"></i>Manager</div><span class="badge-status badge-info">8 users</span></div>
      <div class="stat-row" style="cursor:pointer;padding:10px 8px"><div class="stat-row-label"><i class="bi bi-person me-2"></i>Staff</div><span class="badge-status badge-pending">24 users</span></div>
      <div class="stat-row" style="cursor:pointer;padding:10px 8px"><div class="stat-row-label"><i class="bi bi-eye me-2"></i>Viewer</div><span class="badge-status badge-active">12 users</span></div>
    </div>
  </div>
  <div class="col-md-8">
    <div class="erp-card">
...
<div class="row g-3"><div class="col-md-12"><label class="erp-form-label">Role Name</label><input class="erp-form-control" type="text" placeholder="e.g. Procurement Officer"/></div><div class="col-md-12"><label class="erp-form-label">Description</label><textarea class="erp-form-control" rows="3" placeholder="Describe the role responsibilities…"></textarea></div></div>
      </div>
