...
<head>
  ...
  <title>Shipments — NEXUS ERP</title>
...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">Shipments</span>
  </div>
...
<div class="erp-card">
  <div class="table-toolbar">
    ...
    <select class="erp-form-control" style="width:140px"><option>All Status</option><option>Preparing</option><option>Dispatched</option><option>In Transit</option><option>Delivered</option><option>Failed</option></select>
  </div>
  <div class="erp-table-wrap">
    <table class="erp-table" id="tbl-main">
      <thead><tr><th>Shipment #</th><th>Sales Order</th><th>Customer</th><th>Carrier</th><th>Tracking #</th><th>Est. Delivery</th><th>Status</th><th>Actions</th></tr></thead>
      <tbody><tr><td>SHP-2025-041</td><td>SO-2025-0441</td><td>Acme Corporation</td><td>DHL</td><td>1Z999AA10123456784</td><td>2025-01-15</td><td><span class="badge-status badge-active">Delivered</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalShipment" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Shipment" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>SHP-2025-040</td><td>SO-2025-0440</td><td>Delta Retailers</td><td>FedEx</td><td>779477671000</td><td>2025-01-18</td><td><span class="badge-status badge-pending">In Transit</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalShipment" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Shipment" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>SHP-2025-038</td><td>SO-2025-0438</td><td>Omega Group</td><td>Local Courier</td><td>LC-88421</td><td>2025-01-20</td><td><span class="badge-status badge-info">Dispatched</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalShipment" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Shipment" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>SHP-2025-035</td><td>SO-2025-0435</td><td>BetaCorp</td><td>DHL</td><td>1Z999AA10987654321</td><td>2025-01-14</td><td><span class="badge-status badge-pending">Preparing</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalShipment" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Shipment" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr></tbody>
    </table>
  </div>
...
<div class="row g-3"><div class="col-md-6"><label class="erp-form-label">Sales Order</label><select class="erp-form-control"><option>SO-2025-0441</option><option>SO-2025-0440</option></select></div><div class="col-md-6"><label class="erp-form-label">Carrier</label><select class="erp-form-control"><option>DHL</option><option>FedEx</option><option>UPS</option><option>Local Courier</option></select></div><div class="col-md-6"><label class="erp-form-label">Tracking Number</label><input class="erp-form-control" type="text" placeholder=""/></div><div class="col-md-6"><label class="erp-form-label">Est. Delivery Date</label><input class="erp-form-control" type="date" placeholder=""/></div><div class="col-md-12"><label class="erp-form-label">Shipping Address</label><textarea class="erp-form-control" rows="2" placeholder=""></textarea></div></div>
      </div>
