...
<head>
  ...
  <title>Multi-Warehouse Management — NEXUS ERP</title>
...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">Multi-Warehouse Management</span>
  </div>
...
<div class="erp-card">
  ...
  <div class="erp-table-wrap">
    <table class="erp-table" id="tbl-main">
      ...
      <tbody><tr><td>Main Warehouse</td><td>WH-A</td><td>Dhaka, BD</td><td>James R.</td><td>10,000 units</td><td>7,200 (72%)</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalWarehouse" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Warehouse" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>Secondary Depot</td><td>WH-B</td><td>Chittagong, BD</td><td>Sara L.</td><td>5,000 units</td><td>2,800 (56%)</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalWarehouse" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Warehouse" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>Cold Storage</td><td>WH-C</td><td>Dhaka, BD</td><td>Adam K.</td><td>2,000 units</td><td>1,100 (55%)</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalWarehouse" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Warehouse" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>Archive Store</td><td>WH-D</td><td>Gazipur, BD</td><td>—</td><td>3,000 units</td><td>0 (0%)</td><td><span class="badge-status badge-inactive">Inactive</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalWarehouse" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Warehouse" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr></tbody>
    </table>
  </div>
...
<div class="row g-3"><div class="col-md-6"><label class="erp-form-label">Warehouse Name</label><input class="erp-form-control" type="text" placeholder=""/></div><div class="col-md-3"><label class="erp-form-label">Code</label><input class="erp-form-control" type="text" placeholder="WH-X"/></div><div class="col-md-3"><label class="erp-form-label">Type</label><select class="erp-form-control"><option>Standard</option><option>Cold Storage</option><option>Bonded</option></select></div><div class="col-md-6"><label class="erp-form-label">Location / Address</label><input class="erp-form-control" type="text" placeholder=""/></div><div class="col-md-6"><label class="erp-form-label">Manager</label><select class="erp-form-control"><option>Adam K.</option><option>James R.</option><option>Sara L.</option></select></div><div class="col-md-6"><label class="erp-form-label">Capacity (units)</label><input class="erp-form-control" type="number" placeholder=""/></div></div>
      </div>
