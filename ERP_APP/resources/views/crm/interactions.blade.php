...
<head>
  ...
  <title>Interaction History — NEXUS ERP</title>
...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">Interaction History</span>
  </div>
...
<div class="page-header">
  ...
  <div class="d-flex gap-2">
    ...
    <button class="btn-erp btn-primary" data-bs-toggle="modal" data-bs-target="#modalInteraction"><i class="bi bi-plus-lg"></i> Log Interaction</button>
  </div>
</div>
...
<div class="erp-card">
  ...
  <div class="erp-table-wrap">
    <table class="erp-table" id="tbl-main">
      <thead><tr><th>Date</th><th>Customer</th><th>Contact</th><th>Type</th><th>Summary</th><th>Duration</th><th>Logged By</th><th>Actions</th></tr></thead>
      <tbody><tr><td>2025-01-12</td><td>Acme Corporation</td><td>Bill Gates</td><td>Meeting</td><td>Q1 budget discussion</td><td>45 min</td><td>Sara L.</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalInteraction" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Interaction" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>2025-01-11</td><td>Delta Retailers</td><td>Amy Chen</td><td>Call</td><td>Follow-up on shipment</td><td>12 min</td><td>James R.</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalInteraction" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Interaction" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>2025-01-10</td><td>BetaCorp</td><td>Carlos M.</td><td>Demo</td><td>Product demo – ERP module</td><td>60 min</td><td>Adam K.</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalInteraction" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Interaction" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>2025-01-09</td><td>Omega Group</td><td>Tony Smith</td><td>Email</td><td>Payment reminder sent</td><td>—</td><td>Maya P.</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalInteraction" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Interaction" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr></tbody>
    </table>
  </div>
...
<div class="row g-3"><div class="col-md-6"><label class="erp-form-label">Customer</label><select class="erp-form-control"><option>Acme Corporation</option><option>Delta Retailers</option><option>BetaCorp</option></select></div><div class="col-md-6"><label class="erp-form-label">Contact Person</label><input class="erp-form-control" type="text" placeholder=""/></div><div class="col-md-4"><label class="erp-form-label">Interaction Type</label><select class="erp-form-control"><option>Call</option><option>Email</option><option>Meeting</option><option>Demo</option></select></div><div class="col-md-4"><label class="erp-form-label">Date</label><input class="erp-form-control" type="date" placeholder=""/></div><div class="col-md-4"><label class="erp-form-label">Duration</label><input class="erp-form-control" type="text" placeholder="e.g. 30 min"/></div><div class="col-md-12"><label class="erp-form-label">Summary / Notes</label><textarea class="erp-form-control" rows="3" placeholder=""></textarea></div><div class="col-md-12"><label class="erp-form-label">Next Action</label><input class="erp-form-control" type="text" placeholder="Follow up on…"/></div></div>
      </div>
