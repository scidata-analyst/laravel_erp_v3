  ...
  <main id="main">
    ...
    <div class="page-header">
      ...
      <div class="d-flex gap-2">
        ...
        <button class="btn-erp btn-primary" data-bs-toggle="modal" data-bs-target="#modalInteraction"><i
      ...
      <div class="modal-content"
        ...
        <div class="modal-body">
          <div class="row g-3">
            ...
            <div class="col-md-6"><label class="erp-form-label">Contact Person</label><input class="erp-form-control"
                type="text" placeholder="" /></div>
            <div class="col-md-4"><label class="erp-form-label">Interaction Type</label><select
            ...
            <div class="col-md-4"><label class="erp-form-label">Date</label><input class="erp-form-control" type="date"
                placeholder="" /></div>
            <div class="col-md-4"><label class="erp-form-label">Duration</label><input class="erp-form-control"
                type="text" placeholder="e.g. 30 min" /></div>
            <div class="col-md-12"><label class="erp-form-label">Summary / Notes</label><textarea
                class="erp-form-control" rows="3" placeholder=""></textarea></div>
            <div class="col-md-12"><label class="erp-form-label">Next Action</label><input class="erp-form-control"
                type="text" placeholder="Follow up on…" /></div>
          </div>
        </div>
