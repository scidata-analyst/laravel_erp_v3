...
<head>
  ...
  <title>Customer Support — NEXUS ERP</title>
...
<div class="page-header">
  ...
  <div class="d-flex gap-2">
    ...
    <button class="btn-erp btn-primary" data-bs-toggle="modal" data-bs-target="#modalSupport"><i class="bi bi-plus-lg"></i> New Ticket</button>
  </div>
</div>
...
<div class="erp-card">
  <div class="table-toolbar">
    ...
    <select class="erp-form-control" style="width:140px"><option>All Status</option><option>Open</option><option>In Progress</option><option>Resolved</option><option>Closed</option></select>
  </div>
  <div class="erp-table-wrap">
    <table class="erp-table" id="tbl-main">
      <thead><tr><th>Ticket #</th><th>Customer</th><th>Subject</th><th>Priority</th><th>Assigned To</th><th>Created</th><th>Status</th><th>Actions</th></tr></thead>
      <tbody><tr><td>TKT-2025-088</td><td>Acme Corporation</td><td>Invoice discrepancy issue</td><td>High</td><td>Sara L.</td><td>2025-01-12</td><td><span class="badge-status badge-pending">Open</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalSupport" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Ticket" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>TKT-2025-085</td><td>Delta Retailers</td><td>Delivery delay complaint</td><td>Medium</td><td>James R.</td><td>2025-01-10</td><td><span class="badge-status badge-pending">In Progress</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalSupport" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Ticket" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>TKT-2025-080</td><td>Omega Group</td><td>Product quality defect</td><td>Urgent</td><td>Adam K.</td><td>2025-01-08</td><td><span class="badge-status badge-pending">In Progress</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalSupport" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Ticket" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>TKT-2025-072</td><td>Acme Corporation</td><td>Refund request</td><td>Low</td><td>Sara L.</td><td>2025-01-05</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalSupport" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Ticket" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr></tbody>
    </table>
  </div>
...
<div class="row g-3"><div class="col-md-6"><label class="erp-form-label">Customer</label><select class="erp-form-control"><option>Acme Corporation</option><option>Delta Retailers</option><option>Omega Group</option></select></div><div class="col-md-6"><label class="erp-form-label">Subject</label><input class="erp-form-control" type="text" placeholder=""/></div><div class="col-md-4"><label class="erp-form-label">Priority</label><select class="erp-form-control"><option>Low</option><option>Medium</option><option>High</option><option>Urgent</option></select></div><div class="col-md-4"><label class="erp-form-label">Assign To</label><select class="erp-form-control"><option>Sara L.</option><option>James R.</option><option>Adam K.</option></select></div><div class="col-md-4"><label class="erp-form-label">Category</label><select class="erp-form-control"><option>Billing</option><option>Delivery</option><option>Quality</option><option>Other</option></select></div><div class="col-md-12"><label class="erp-form-label">Description</label><textarea class="erp-form-control" rows="3" placeholder=""></textarea></div></div>
      </div>
