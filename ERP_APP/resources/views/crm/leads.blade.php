...
<head>
  ...
  <title>Leads & Opportunities — NEXUS ERP</title>
...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">Leads & Opportunities</span>
  </div>
...
<div class="page-header">
  ...
  <div class="d-flex gap-2">
    ...
    <button class="btn-erp btn-primary" data-bs-toggle="modal" data-bs-target="#modalLead"><i class="bi bi-plus-lg"></i> New Lead</button>
  </div>
</div>
<div class="row g-3 mb-3">
      <div class="col-md-3"><div class="kpi-tile blue"><div class="kpi-icon blue"><i class="bi bi-funnel"></i></div><div class="kpi-value">84</div><div class="kpi-label">Total Leads</div></div></div>
      <div class="col-md-3"><div class="kpi-tile yellow"><div class="kpi-icon yellow"><i class="bi bi-trophy"></i></div><div class="kpi-value">26</div><div class="kpi-label">Opportunities</div></div></div>
      <div class="col-md-3"><div class="kpi-tile green"><div class="kpi-icon green"><i class="bi bi-check2-all"></i></div><div class="kpi-value">18</div><div class="kpi-label">Won</div></div></div>
      <div class="col-md-3"><div class="kpi-tile red"><div class="kpi-icon red"><i class="bi bi-x-circle"></i></div><div class="kpi-value">9</div><div class="kpi-label">Lost</div></div></div>
    </div>
<div class="erp-card">
  <div class="table-toolbar">
    ...
    <select class="erp-form-control" style="width:140px"><option>All Status</option><option>New</option><option>Qualified</option><option>Proposal</option><option>Won</option><option>Lost</option></select>
  </div>
  <div class="erp-table-wrap">
    <table class="erp-table" id="tbl-main">
      <thead><tr><th>Lead</th><th>Company</th><th>Value</th><th>Stage</th><th>Assigned To</th><th>Next Action</th><th>Actions</th></tr></thead>
      <tbody><tr><td>John Doe</td><td>Alpha Tech</td><td>$45,000</td><td><span class="badge-status badge-info">Proposal</span></td><td>Sara L.</td><td>2025-01-20</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalLead" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Lead" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>Emma Brown</td><td>Sunrise Ltd.</td><td>$12,000</td><td><span class="badge-status badge-pending">Qualified</span></td><td>James R.</td><td>2025-01-22</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalLead" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Lead" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>Carlos M.</td><td>BetaCorp</td><td>$88,000</td><td><span class="badge-status badge-active">Won</span></td><td>Sara L.</td><td>Closed</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalLead" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Lead" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr></tbody>
    </table>
  </div>
...
<div class="row g-3"><div class="col-md-6"><label class="erp-form-label">Lead Name</label><input class="erp-form-control" type="text" placeholder=""/></div><div class="col-md-6"><label class="erp-form-label">Company</label><input class="erp-form-control" type="text" placeholder=""/></div><div class="col-md-6"><label class="erp-form-label">Email</label><input class="erp-form-control" type="email" placeholder=""/></div><div class="col-md-6"><label class="erp-form-label">Phone</label><input class="erp-form-control" type="text" placeholder=""/></div><div class="col-md-4"><label class="erp-form-label">Deal Value ($)</label><input class="erp-form-control" type="number" placeholder=""/></div><div class="col-md-4"><label class="erp-form-label">Stage</label><select class="erp-form-control"><option>New</option><option>Qualified</option><option>Proposal</option><option>Won</option><option>Lost</option></select></div><div class="col-md-4"><label class="erp-form-label">Assigned To</label><select class="erp-form-control"><option>Sara L.</option><option>James R.</option></select></div><div class="col-md-12"><label class="erp-form-label">Notes</label><textarea class="erp-form-control" rows="2" placeholder=""></textarea></div></div>
      </div>
