...
<head>
  ...
  <title>Financial Reports — NEXUS ERP</title>
...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">Financial Reports</span>
  </div>
...
<div class="page-header">
  ...
  <div class="d-flex gap-2">
    ...
    <button class="btn-erp btn-primary" data-bs-toggle="modal" data-bs-target="#modalFinReport"><i class="bi bi-plus-lg"></i> Generate Report</button>
  </div>
</div>
...
<div class="erp-card">
  <div class="table-toolbar">
    ...
    <select class="erp-form-control" style="width:140px"><option>All Status</option><option>P&L</option><option>Balance Sheet</option><option>Cash Flow</option></select>
  </div>
  <div class="erp-table-wrap">
    <table class="erp-table" id="tbl-main">
      <thead><tr><th>Report Name</th><th>Type</th><th>Period</th><th>Generated On</th><th>Generated By</th><th>Format</th><th>Actions</th></tr></thead>
      <tbody><tr><td>P&L January 2025</td><td>Profit & Loss</td><td>Jan 2025</td><td>2025-01-12</td><td>Maya P.</td><td>PDF</td><td><div class="d-flex gap-1"><button class="btn-erp btn-success btn-xs btn-icon btn-export" title="Download"><i class="bi bi-download"></i></button><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalFinReport" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Generate Report" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>Balance Sheet Q4 2024</td><td>Balance Sheet</td><td>Q4 2024</td><td>2025-01-02</td><td>Maya P.</td><td>Excel</td><td><div class="d-flex gap-1"><button class="btn-erp btn-success btn-xs btn-icon btn-export" title="Download"><i class="bi bi-download"></i></button><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalFinReport" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Generate Report" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>Cash Flow Dec 2024</td><td>Cash Flow</td><td>Dec 2024</td><td>2024-12-31</td><td>Adam K.</td><td>PDF</td><td><div class="d-flex gap-1"><button class="btn-erp btn-success btn-xs btn-icon btn-export" title="Download"><i class="bi bi-download"></i></button><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalFinReport" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Generate Report" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>Trial Balance Jan 2025</td><td>Trial Balance</td><td>Jan 2025</td><td>2025-01-12</td><td>Maya P.</td><td>PDF</td><td><div class="d-flex gap-1"><button class="btn-erp btn-success btn-xs btn-icon btn-export" title="Download"><i class="bi bi-download"></i></button><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalFinReport" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Generate Report" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr></tbody>
    </table>
  </div>
...
<div class="row g-3"><div class="col-md-6"><label class="erp-form-label">Report Type</label><select class="erp-form-control"><option>Profit & Loss</option><option>Balance Sheet</option><option>Cash Flow</option><option>Trial Balance</option></select></div><div class="col-md-6"><label class="erp-form-label">Period</label><select class="erp-form-control"><option>This Month</option><option>Last Month</option><option>This Quarter</option><option>Custom</option></select></div><div class="col-md-6"><label class="erp-form-label">From Date</label><input class="erp-form-control" type="date" placeholder=""/></div><div class="col-md-6"><label class="erp-form-label">To Date</label><input class="erp-form-control" type="date" placeholder=""/></div><div class="col-md-4"><label class="erp-form-label">Format</label><select class="erp-form-control"><option>PDF</option><option>Excel</option></select></div></div>
      </div>
