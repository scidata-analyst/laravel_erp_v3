...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">AP / AR</span>
  </div>
...
<div class="page-header">
  ...
  <div class="d-flex gap-2">
    ...
    <button class="btn-erp btn-primary" data-bs-toggle="modal" data-bs-target="#modalAPAR"><i class="bi bi-plus-lg"></i> New Transaction</button>
  </div>
</div>
...
<div class="erp-card">
  <div class="table-toolbar">
    ...
    <select class="erp-form-control" style="width:140px"><option>All Status</option><option>Payable</option><option>Receivable</option></select>
  </div>
  <div class="erp-table-wrap">
    <table class="erp-table" id="tbl-main">
      <thead><tr><th>Ref #</th><th>Party</th><th>Type</th><th>Due Date</th><th>Amount</th><th>Paid</th><th>Balance</th><th>Status</th><th>Actions</th></tr></thead>
      <tbody><tr><td>AP-2025-012</td><td>TechSource Ltd.</td><td>Payable</td><td>2025-02-12</td><td>$32,400</td><td>$0</td><td>$32,400</td><td><span class="badge-status badge-pending">Pending</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalAPAR" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Transaction" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>AR-2025-044</td><td>Acme Corporation</td><td>Receivable</td><td>2025-01-31</td><td>$12,400</td><td>$12,400</td><td>$0</td><td><span class="badge-status badge-active">Paid</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalAPAR" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Transaction" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>AP-2025-011</td><td>GlobalParts Inc.</td><td>Payable</td><td>2025-01-25</td><td>$8,750</td><td>$4,000</td><td>$4,750</td><td><span class="badge-status badge-pending">Partial</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalAPAR" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Transaction" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>AR-2025-039</td><td>Omega Group</td><td>Receivable</td><td>2025-01-01</td><td>$10,800</td><td>$0</td><td>$10,800</td><td><span class="badge-status badge-inactive">Overdue</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalAPAR" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Transaction" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr></tbody>
    </table>
  </div>
...
<div class="row g-3"><div class="col-md-6"><label class="erp-form-label">Party Name</label><input class="erp-form-control" type="text" placeholder=""/></div><div class="col-md-6"><label class="erp-form-label">Type</label><select class="erp-form-control"><option>Payable</option><option>Receivable</option></select></div><div class="col-md-4"><label class="erp-form-label">Amount ($)</label><input class="erp-form-control" type="number" placeholder=""/></div><div class="col-md-4"><label class="erp-form-label">Due Date</label><input class="erp-form-control" type="date" placeholder=""/></div><div class="col-md-4"><label class="erp-form-label">Reference</label><input class="erp-form-control" type="text" placeholder="Invoice/PO ref"/></div></div>
      </div>
