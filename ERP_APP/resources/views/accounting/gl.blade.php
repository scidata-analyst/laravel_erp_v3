...
<head>
  ...
  <title>General Ledger — NEXUS ERP</title>
...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">General Ledger</span>
  </div>
...
<div class="page-header">
  ...
  <div class="d-flex gap-2">
    ...
    <button class="btn-erp btn-primary" data-bs-toggle="modal" data-bs-target="#modalGL"><i class="bi bi-plus-lg"></i> New Entry</button>
  </div>
</div>
...
<div class="erp-card">
  <div class="table-toolbar">
    ...
    <select class="erp-form-control" style="width:140px"><option>All Status</option><option>Assets</option><option>Liabilities</option><option>Equity</option><option>Revenue</option><option>Expense</option></select>
  </div>
  <div class="erp-table-wrap">
    <table class="erp-table" id="tbl-main">
      <thead><tr><th>Account Code</th><th>Account Name</th><th>Type</th><th>Debit</th><th>Credit</th><th>Balance</th><th>Actions</th></tr></thead>
      <tbody><tr><td>1001</td><td>Cash & Cash Equivalents</td><td><span class="badge-status badge-info">Asset</span></td><td>$420,000</td><td>$180,000</td><td>$240,000</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalGL" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Entry" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>2001</td><td>Accounts Payable</td><td><span class="badge-status badge-info">Liability</span></td><td>$50,000</td><td>$120,000</td><td>($70,000)</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalGL" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Entry" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>4001</td><td>Sales Revenue</td><td><span class="badge-status badge-info">Revenue</span></td><td>$0</td><td>$2,400,000</td><td>$2,400,000</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalGL" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Entry" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>5001</td><td>Cost of Goods Sold</td><td><span class="badge-status badge-info">Expense</span></td><td>$1,560,000</td><td>$0</td><td>($1,560,000)</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalGL" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Entry" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr></tbody>
    </table>
  </div>
...
<div class="row g-3"><div class="col-md-6"><label class="erp-form-label">Account Code</label><input class="erp-form-control" type="text" placeholder="e.g. 1001"/></div><div class="col-md-6"><label class="erp-form-label">Account Name</label><input class="erp-form-control" type="text" placeholder=""/></div><div class="col-md-6"><label class="erp-form-label">Account Type</label><select class="erp-form-control"><option>Asset</option><option>Liability</option><option>Equity</option><option>Revenue</option><option>Expense</option></select></div><div class="col-md-3"><label class="erp-form-label">Debit ($)</label><input class="erp-form-control" type="number" placeholder=""/></div><div class="col-md-3"><label class="erp-form-label">Credit ($)</label><input class="erp-form-control" type="number" placeholder=""/></div><div class="col-md-12"><label class="erp-form-label">Narration</label><textarea class="erp-form-control" rows="2" placeholder=""></textarea></div></div>
      </div>
