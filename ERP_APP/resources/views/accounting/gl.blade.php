  ...
  <main id="main">
    ...
    <div class="page-header">
      ...
      <div class="d-flex gap-2">
        ...
        <button class="btn-erp btn-primary" data-bs-toggle="modal" data-bs-target="#modalGL"><i
    ...
    <div class="modal-dialog  modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content"
        ...
        <div class="modal-body">
          <div class="row g-3">
            <div class="col-md-6"><label class="erp-form-label">Account Code</label><input class="erp-form-control"
                type="text" placeholder="e.g. 1001" /></div>
            <div class="col-md-6"><label class="erp-form-label">Account Name</label><input class="erp-form-control"
                type="text" placeholder="" /></div>
            <div class="col-md-6"><label class="erp-form-label">Account Type</label><select class="erp-form-control">
                <option>Asset</option>
            ...
            <div class="col-md-3"><label class="erp-form-label">Debit ($)</label><input class="erp-form-control"
                type="number" placeholder="" /></div>
            <div class="col-md-3"><label class="erp-form-label">Credit ($)</label><input class="erp-form-control"
                type="number" placeholder="" /></div>
            <div class="col-md-12"><label class="erp-form-label">Narration</label><textarea class="erp-form-control"
