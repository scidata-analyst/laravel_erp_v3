...
<head>
  ...
  <title>Tax & Compliance — NEXUS ERP</title>
...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">Tax & Compliance</span>
  </div>
...
<div class="page-header">
  ...
  <div class="d-flex gap-2">
    ...
    <button class="btn-erp btn-primary" data-bs-toggle="modal" data-bs-target="#modalTax"><i class="bi bi-plus-lg"></i> New Tax Rule</button>
  </div>
</div>
...
<div class="erp-card">
  ...
  <div class="erp-table-wrap">
    <table class="erp-table" id="tbl-main">
      <thead><tr><th>Tax Name</th><th>Type</th><th>Rate</th><th>Applicable On</th><th>Filing Period</th><th>Last Filed</th><th>Status</th><th>Actions</th></tr></thead>
      <tbody><tr><td>VAT Standard</td><td>VAT</td><td>15%</td><td>All Sales</td><td>Monthly</td><td>2025-01-01</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalTax" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Tax Rule" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>Input Tax Credit</td><td>VAT</td><td>15%</td><td>Purchases</td><td>Monthly</td><td>2025-01-01</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalTax" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Tax Rule" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>Withholding Tax</td><td>WHT</td><td>5%</td><td>Supplier Payments</td><td>Quarterly</td><td>2024-10-01</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalTax" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Tax Rule" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>Export Zero Rate</td><td>VAT</td><td>0%</td><td>Export Sales</td><td>Monthly</td><td>2025-01-01</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalTax" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Tax Rule" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr></tbody>
    </table>
  </div>
...
<div class="row g-3"><div class="col-md-6"><label class="erp-form-label">Tax Name</label><input class="erp-form-control" type="text" placeholder=""/></div><div class="col-md-6"><label class="erp-form-label">Tax Type</label><select class="erp-form-control"><option>VAT</option><option>Sales Tax</option><option>Withholding</option></select></div><div class="col-md-4"><label class="erp-form-label">Rate (%)</label><input class="erp-form-control" type="number" placeholder=""/></div><div class="col-md-4"><label class="erp-form-label">Filing Period</label><select class="erp-form-control"><option>Monthly</option><option>Quarterly</option><option>Annually</option></select></div><div class="col-md-4"><label class="erp-form-label">Applicable On</label><select class="erp-form-control"><option>Sales</option><option>Purchases</option><option>Both</option></select></div></div>
      </div>
