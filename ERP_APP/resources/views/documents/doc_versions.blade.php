...
<head>
  ...
  <title>Version Control — NEXUS ERP</title>
...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">Version Control</span>
  </div>
...
<div class="erp-card">
  <div class="table-toolbar">
    ...
    <select class="erp-form-control" style="width:140px"><option>All Status</option><option>Latest</option><option>Archived</option></select>
  </div>
  <div class="erp-table-wrap">
    <table class="erp-table" id="tbl-main">
      ...
      <tbody><tr><td>Supplier Agreement – TechSource</td><td>v2.1</td><td>Adam K.</td><td>Updated payment clause</td><td>2025-01-10</td><td>Sara L.</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalVersion" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Version" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>Supplier Agreement – TechSource</td><td>v2.0</td><td>Sara L.</td><td>Added penalty terms</td><td>2024-10-01</td><td>Adam K.</td><td><span class="badge-status badge-inactive">Archived</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalVersion" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Version" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>Employee Handbook</td><td>v3.0</td><td>Maya P.</td><td>Annual policy update</td><td>2025-01-05</td><td>Adam K.</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalVersion" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Version" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>Quality Manual ISO 9001</td><td>v1.2</td><td>Nadia Q.</td><td>Revised QC section 4.2</td><td>2024-11-15</td><td>Adam K.</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalVersion" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Version" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr></tbody>
    </table>
  </div>
...
<div class="row g-3"><div class="col-md-6"><label class="erp-form-label">Document</label><select class="erp-form-control"><option>Supplier Agreement – TechSource</option><option>Employee Handbook</option><option>Quality Manual</option></select></div><div class="col-md-3"><label class="erp-form-label">New Version</label><input class="erp-form-control" type="text" placeholder="v2.2"/></div><div class="col-md-3"><label class="erp-form-label">Change Type</label><select class="erp-form-control"><option>Minor</option><option>Major</option><option>Correction</option></select></div><div class="col-md-12"><label class="erp-form-label">Change Summary</label><textarea class="erp-form-control" rows="2" placeholder="Describe what changed…"></textarea></div><div class="col-md-6"><label class="erp-form-label">Approver</label><select class="erp-form-control"><option>Adam K.</option><option>Sara L.</option><option>Maya P.</option></select></div><div class="col-md-6"><label class="erp-form-label">Upload New File</label><input class="erp-form-control" type="file" placeholder=""/></div></div>
      </div>
