...
<head>
  ...
  <title>Document Library — NEXUS ERP</title>
...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">Document Library</span>
  </div>
...
<div class="erp-card">
  <div class="table-toolbar">
    ...
    <select class="erp-form-control" style="width:140px"><option>All Status</option><option>Contract</option><option>Invoice</option><option>PO</option><option>Report</option></select>
  </div>
  <div class="erp-table-wrap">
    <table class="erp-table" id="tbl-main">
      ...
      <tbody><tr><td>Supplier Agreement – TechSource</td><td>Contract</td><td>TechSource Ltd.</td><td>v2.1</td><td>245 KB</td><td>Adam K.</td><td>2025-01-10</td><td><div class="d-flex gap-1"><button class="btn-erp btn-success btn-xs btn-icon btn-export" title="Download"><i class="bi bi-download"></i></button><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDocument" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Upload Document" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>INV-8823 – Acme Corp</td><td>Invoice</td><td>Acme Corporation</td><td>v1.0</td><td>88 KB</td><td>Maya P.</td><td>2025-01-12</td><td><div class="d-flex gap-1"><button class="btn-erp btn-success btn-xs btn-icon btn-export" title="Download"><i class="bi bi-download"></i></button><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDocument" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Upload Document" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>PO-2025-0091</td><td>Purchase Order</td><td>TechSource Ltd.</td><td>v1.0</td><td>120 KB</td><td>Sara L.</td><td>2025-01-12</td><td><div class="d-flex gap-1"><button class="btn-erp btn-success btn-xs btn-icon btn-export" title="Download"><i class="bi bi-download"></i></button><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDocument" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Upload Document" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>Q4 2024 Audit Report</td><td>Report</td><td>Finance Dept.</td><td>v1.0</td><td>1.2 MB</td><td>Maya P.</td><td>2025-01-02</td><td><div class="d-flex gap-1"><button class="btn-erp btn-success btn-xs btn-icon btn-export" title="Download"><i class="bi bi-download"></i></button><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDocument" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Upload Document" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr></tbody>
    </table>
  </div>
...
<div class="row g-3"><div class="col-md-6"><label class="erp-form-label">Document Name</label><input class="erp-form-control" type="text" placeholder=""/></div><div class="col-md-6"><label class="erp-form-label">Document Type</label><select class="erp-form-control"><option>Contract</option><option>Invoice</option><option>Purchase Order</option><option>Report</option><option>Certificate</option></select></div><div class="col-md-6"><label class="erp-form-label">Related To</label><input class="erp-form-control" type="text" placeholder="Supplier, Customer, Project…"/></div><div class="col-md-3"><label class="erp-form-label">Version</label><input class="erp-form-control" type="text" placeholder="v1.0"/></div><div class="col-md-3"><label class="erp-form-label">Access Level</label><select class="erp-form-control"><option>Public</option><option>Private</option><option>Restricted</option></select></div><div class="col-md-12"><label class="erp-form-label">Upload File</label><input class="erp-form-control" type="file" placeholder=""/></div><div class="col-md-12"><label class="erp-form-label">Notes</label><textarea class="erp-form-control" rows="2" placeholder=""></textarea></div></div>
      </div>
