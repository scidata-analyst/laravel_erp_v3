...
<head>
  ...
  <title>Work Orders — NEXUS ERP</title>
...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">Work Orders</span>
  </div>
...
<div class="page-header">
  ...
  <div class="d-flex gap-2">
    ...
    <button class="btn-erp btn-primary" data-bs-toggle="modal" data-bs-target="#modalWorkOrder"><i class="bi bi-plus-lg"></i> New Work Order</button>
  </div>
</div>
...
<div class="erp-card">
  <div class="table-toolbar">
    ...
    <select class="erp-form-control" style="width:140px"><option>All Status</option><option>Scheduled</option><option>In Progress</option><option>Completed</option><option>On Hold</option></select>
  </div>
  <div class="erp-table-wrap">
    <table class="erp-table" id="tbl-main">
      <thead><tr><th>WO #</th><th>Product</th><th>BOM</th><th>Qty</th><th>Start Date</th><th>End Date</th><th>Assigned To</th><th>Status</th><th>Actions</th></tr></thead>
      <tbody><tr><td>WO-2025-011</td><td>Assembled PCB Board</td><td>BOM-001</td><td>200 units</td><td>2025-01-13</td><td>2025-01-16</td><td>Workshop A</td><td><span class="badge-status badge-pending">In Progress</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalWorkOrder" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Work Order" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>WO-2025-010</td><td>Custom Cable Assembly</td><td>BOM-002</td><td>500 units</td><td>2025-01-12</td><td>2025-01-13</td><td>Workshop B</td><td><span class="badge-status badge-active">Completed</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalWorkOrder" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Work Order" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>WO-2025-009</td><td>Sensor Module</td><td>BOM-003</td><td>50 units</td><td>2025-01-20</td><td>2025-01-25</td><td>Workshop A</td><td><span class="badge-status badge-pending">Scheduled</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalWorkOrder" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Work Order" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>WO-2025-008</td><td>Power Supply Unit</td><td>BOM-004</td><td>100 units</td><td>2025-01-10</td><td>2025-01-12</td><td>Workshop C</td><td><span class="badge-status badge-info">On Hold</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalWorkOrder" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Work Order" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr></tbody>
    </table>
  </div>
...
<div class="row g-3"><div class="col-md-6"><label class="erp-form-label">Product / BOM</label><select class="erp-form-control"><option>BOM-001 – Assembled PCB Board</option><option>BOM-002 – Custom Cable</option></select></div><div class="col-md-3"><label class="erp-form-label">Qty to Produce</label><input class="erp-form-control" type="number" placeholder=""/></div><div class="col-md-3"><label class="erp-form-label">Priority</label><select class="erp-form-control"><option>Normal</option><option>High</option><option>Urgent</option></select></div><div class="col-md-4"><label class="erp-form-label">Start Date</label><input class="erp-form-control" type="date" placeholder=""/></div><div class="col-md-4"><label class="erp-form-label">End Date</label><input class="erp-form-control" type="date" placeholder=""/></div><div class="col-md-4"><label class="erp-form-label">Workshop / Line</label><select class="erp-form-control"><option>Workshop A</option><option>Workshop B</option><option>Workshop C</option></select></div></div>
      </div>
