...
<head>
  ...
  <title>Machine & Labor — NEXUS ERP</title>
...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">Machine & Labor</span>
  </div>
...
<div class="page-header">
  ...
  <div class="d-flex gap-2">
    ...
    <button class="btn-erp btn-primary" data-bs-toggle="modal" data-bs-target="#modalMachineLabor"><i class="bi bi-plus-lg"></i> Log Entry</button>
  </div>
</div>
...
<div class="erp-card">
  ...
  <div class="erp-table-wrap">
    <table class="erp-table" id="tbl-main">
      <thead><tr><th>Work Order</th><th>Resource</th><th>Type</th><th>Scheduled Hours</th><th>Actual Hours</th><th>Cost/hr</th><th>Total Cost</th><th>Actions</th></tr></thead>
      <tbody><tr><td>WO-2025-011</td><td>CNC Machine #1</td><td>Machine</td><td>8h</td><td>8.5h</td><td>$25.00</td><td>$212.50</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalMachineLabor" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Entry" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>WO-2025-011</td><td>John (Operator)</td><td>Labor</td><td>8h</td><td>8.5h</td><td>$18.00</td><td>$153.00</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalMachineLabor" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Entry" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>WO-2025-010</td><td>Assembly Line B</td><td>Machine</td><td>4h</td><td>3.8h</td><td>$30.00</td><td>$114.00</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalMachineLabor" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Entry" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>WO-2025-010</td><td>Sarah (Tech)</td><td>Labor</td><td>4h</td><td>4h</td><td>$22.00</td><td>$88.00</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalMachineLabor" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Entry" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr></tbody>
    </table>
  </div>
...
<div class="row g-3"><div class="col-md-6"><label class="erp-form-label">Work Order</label><select class="erp-form-control"><option>WO-2025-011</option><option>WO-2025-010</option></select></div><div class="col-md-6"><label class="erp-form-label">Resource Name</label><input class="erp-form-control" type="text" placeholder="Machine or employee name"/></div><div class="col-md-4"><label class="erp-form-label">Type</label><select class="erp-form-control"><option>Machine</option><option>Labor</option></select></div><div class="col-md-4"><label class="erp-form-label">Hours Used</label><input class="erp-form-control" type="number" placeholder=""/></div><div class="col-md-4"><label class="erp-form-label">Cost per Hour ($)</label><input class="erp-form-control" type="number" placeholder=""/></div></div>
      </div>
