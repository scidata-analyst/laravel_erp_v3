...
<head>
  ...
  <title>Custom Reports — NEXUS ERP</title>
...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">Custom Reports</span>
  </div>
...
<div class="row g-3"><div class="col-md-6"><label class="erp-form-label">Report Name</label><input class="erp-form-control" type="text" placeholder=""/></div><div class="col-md-6"><label class="erp-form-label">Module</label><select class="erp-form-control"><option>Sales</option><option>Purchase</option><option>Inventory</option><option>Finance</option><option>HR</option></select></div><div class="col-md-12"><label class="erp-form-label">Select Fields</label><input class="erp-form-control" type="text" placeholder="e.g. Customer Name, Order Date, Total Amount"/></div><div class="col-md-4"><label class="erp-form-label">Filter By</label><select class="erp-form-control"><option>Date Range</option><option>Status</option><option>Department</option></select></div><div class="col-md-4"><label class="erp-form-label">Schedule</label><select class="erp-form-control"><option>Manual</option><option>Daily</option><option>Weekly</option><option>Monthly</option></select></div><div class="col-md-4"><label class="erp-form-label">Output Format</label><select class="erp-form-control"><option>PDF</option><option>Excel</option><option>Both</option></select></div></div>
      </div>
