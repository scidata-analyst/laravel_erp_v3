...
<head>
  ...
  <title>Online Sales Channels — NEXUS ERP</title>
...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">Online Sales Channels</span>
  </div>
...
<div class="erp-card">
  <div class="table-toolbar">
    ...
    <select class="erp-form-control" style="width:140px"><option>All Status</option><option>Shopify</option><option>WooCommerce</option><option>Daraz</option><option>Facebook</option></select>
  </div>
  <div class="erp-table-wrap">
    <table class="erp-table" id="tbl-main">
      <thead><tr><th>Channel Name</th><th>Platform</th><th>Orders (MTD)</th><th>Revenue (MTD)</th><th>Sync Status</th><th>Last Synced</th><th>Status</th><th>Actions</th></tr></thead>
      <tbody><tr><td>Main Store</td><td>Shopify</td><td>142</td><td>$28,400</td><td>Synced</td><td>2025-01-12 10:30</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalChannel" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Channel" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>BD Marketplace</td><td>Daraz</td><td>88</td><td>$9,200</td><td>Synced</td><td>2025-01-12 09:15</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalChannel" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Channel" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>Social Shop</td><td>Facebook</td><td>34</td><td>$4,100</td><td>Error</td><td>2025-01-11 18:00</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalChannel" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Channel" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>EU Store</td><td>WooCommerce</td><td>21</td><td>$6,800</td><td>Synced</td><td>2025-01-12 08:00</td><td><span class="badge-status badge-inactive">Inactive</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalChannel" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Channel" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr></tbody>
    </table>
  </div>
...
<div class="row g-3"><div class="col-md-6"><label class="erp-form-label">Channel Name</label><input class="erp-form-control" type="text" placeholder=""/></div><div class="col-md-6"><label class="erp-form-label">Platform</label><select class="erp-form-control"><option>Shopify</option><option>WooCommerce</option><option>Daraz</option><option>Facebook Shop</option></select></div><div class="col-md-12"><label class="erp-form-label">API / Store URL</label><input class="erp-form-control" type="text" placeholder="https://yourstore.myshopify.com"/></div><div class="col-md-6"><label class="erp-form-label">API Key</label><input class="erp-form-control" type="password" placeholder="••••••••••••"/></div><div class="col-md-6"><label class="erp-form-label">Sync Frequency</label><select class="erp-form-control"><option>Every 15 min</option><option>Every hour</option><option>Daily</option></select></div></div>
      </div>
