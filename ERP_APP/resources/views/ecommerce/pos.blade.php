...
<head>
  ...
  <title>POS Terminals — NEXUS ERP</title>
...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">POS Terminals</span>
  </div>
...
<div class="erp-card">
  <div class="table-toolbar">
    ...
    <select class="erp-form-control" style="width:140px"><option>All Status</option><option>Online</option><option>Offline</option><option>Closed</option></select>
  </div>
  <div class="erp-table-wrap">
    <table class="erp-table" id="tbl-main">
      <thead><tr><th>Terminal ID</th><th>Location</th><th>Cashier</th><th>Session Start</th><th>Sales (Today)</th><th>Transactions</th><th>Status</th><th>Actions</th></tr></thead>
      <tbody><tr><td>POS-001</td><td>Main Store – Counter 1</td><td>Anika R.</td><td>2025-01-12 09:00</td><td>$4,820</td><td>42 txns</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalPOS" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Terminal" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>POS-002</td><td>Main Store – Counter 2</td><td>Farhan S.</td><td>2025-01-12 09:00</td><td>$3,110</td><td>28 txns</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalPOS" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Terminal" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>POS-003</td><td>Branch – Gulshan</td><td>Tania M.</td><td>2025-01-12 10:00</td><td>$1,940</td><td>18 txns</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalPOS" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Terminal" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>POS-004</td><td>Branch – Dhanmondi</td><td>—</td><td>—</td><td>$0</td><td>0 txns</td><td><span class="badge-status badge-inactive">Offline</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalPOS" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Terminal" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr></tbody>
    </table>
  </div>
...
<div class="row g-3"><div class="col-md-6"><label class="erp-form-label">Terminal ID</label><input class="erp-form-control" type="text" placeholder="POS-XXX"/></div><div class="col-md-6"><label class="erp-form-label">Location</label><input class="erp-form-control" type="text" placeholder=""/></div><div class="col-md-6"><label class="erp-form-label">Assigned Cashier</label><select class="erp-form-control"><option>Anika R.</option><option>Farhan S.</option><option>Tania M.</option></select></div><div class="col-md-6"><label class="erp-form-label">Warehouse / Inventory</label><select class="erp-form-control"><option>WH-A</option><option>WH-B</option></select></div><div class="col-md-6"><label class="erp-form-label">Receipt Printer</label><input class="erp-form-control" type="text" placeholder="Printer IP or model"/></div></div>
      </div>
