...
<head>
  ...
  <title>Tasks & Milestones — NEXUS ERP</title>
...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">Tasks & Milestones</span>
  </div>
...
<div class="page-header">
  ...
  <button class="btn-erp btn-primary" data-bs-toggle="modal" data-bs-target="#modalTask"><i class="bi bi-plus-lg"></i> Add Task</button>
</div>
<div class="erp-card">
  <div class="erp-tabs">
  ...
  <div id="tab-kanban" class="tab-panel active">
    <div class="row g-3">
      <div class="col-md-3"><div style="background:var(--bg-elevated);border-radius:var(--radius);padding:12px">
        <div class="d-flex justify-content-between align-items-center mb-3"><span style="font-size:12px;font-weight:600;color:var(--text-muted)">TODO</span><span class="badge-status badge-info">3</span></div>
        <div class="erp-card mb-2" style="padding:12px;cursor:grab"><div style="font-size:13px;font-weight:500">Design mockups</div><div style="font-size:11px;color:var(--text-muted);margin-top:4px">Due: Jan 20</div><div class="d-flex gap-1 mt-2"><span class="tag">Design</span></div></div>
        <div class="erp-card mb-2" style="padding:12px;cursor:grab"><div style="font-size:13px;font-weight:500">Backend API docs</div><div style="font-size:11px;color:var(--text-muted);margin-top:4px">Due: Jan 22</div></div>
      </div></div>
      <div class="col-md-3"><div style="background:var(--bg-elevated);border-radius:var(--radius);padding:12px">
        <div class="d-flex justify-content-between align-items-center mb-3"><span style="font-size:12px;font-weight:600;color:var(--accent-4)">IN PROGRESS</span><span class="badge-status badge-pending">2</span></div>
        <div class="erp-card mb-2" style="padding:12px;cursor:grab;border-color:var(--accent-4)"><div style="font-size:13px;font-weight:500">Database migration</div><div style="font-size:11px;color:var(--text-muted);margin-top:4px">Due: Jan 15</div><div class="erp-progress mt-2"><div class="erp-progress-bar" style="width:65%;background:var(--accent-4)"></div></div></div>
      </div></div>
      <div class="col-md-3"><div style="background:var(--bg-elevated);border-radius:var(--radius);padding:12px">
        <div class="d-flex justify-content-between align-items-center mb-3"><span style="font-size:12px;font-weight:600;color:var(--accent)">REVIEW</span><span class="badge-status badge-info">1</span></div>
        <div class="erp-card mb-2" style="padding:12px;cursor:grab;border-color:var(--accent)"><div style="font-size:13px;font-weight:500">QA Testing round 2</div><div style="font-size:11px;color:var(--text-muted);margin-top:4px">Due: Jan 14</div></div>
      </div></div>
      <div class="col-md-3"><div style="background:var(--bg-elevated);border-radius:var(--radius);padding:12px">
        <div class="d-flex justify-content-between align-items-center mb-3"><span style="font-size:12px;font-weight:600;color:var(--accent-2)">DONE</span><span class="badge-status badge-active">4</span></div>
        <div class="erp-card mb-2" style="padding:12px;opacity:.7"><div style="font-size:13px;font-weight:500;text-decoration:line-through">Setup dev environment</div></div>
        <div class="erp-card mb-2" style="padding:12px;opacity:.7"><div style="font-size:13px;font-weight:500;text-decoration:line-through">Write user stories</div></div>
      </div></div>
    </div>
  </div>
  <div id="tab-list" class="tab-panel">
    <div class="erp-table-wrap">
      <table class="erp-table">
        <thead><tr><th>Task</th><th>Project</th><th>Assignee</th><th>Priority</th><th>Due Date</th><th>Status</th><th>Actions</th></tr></thead>
        <tbody>
          <tr><td>Design mockups</td><td>ERP v2</td><td>Adam K.</td><td><span class="badge-status badge-inactive">High</span></td><td>Jan 20</td><td><span class="badge-status badge-info">Draft</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalTask" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Task" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
          <tr><td>Database migration</td><td>ERP v2</td><td>James R.</td><td><span class="badge-status badge-pending">Medium</span></td><td>Jan 15</td><td><span class="badge-status badge-pending">In Progress</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalTask" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Task" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
        </tbody>
      </table>
    </div>
  </div>
...
<div class="row g-3"><div class="col-md-12"><label class="erp-form-label">Task Title</label><input class="erp-form-control" type="text" placeholder=""/></div><div class="col-md-6"><label class="erp-form-label">Project</label><input class="erp-form-control" type="text" placeholder="Project name"/></div><div class="col-md-6"><label class="erp-form-label">Assignee</label><select class="erp-form-control"><option>Adam K.</option><option>Sara L.</option><option>James R.</option></select></div><div class="col-md-4"><label class="erp-form-label">Priority</label><select class="erp-form-control"><option>High</option><option>Medium</option><option>Low</option></select></div><div class="col-md-4"><label class="erp-form-label">Due Date</label><input class="erp-form-control" type="date" placeholder=""/></div><div class="col-md-4"><label class="erp-form-label">Status</label><select class="erp-form-control"><option>Todo</option><option>In Progress</option><option>Review</option><option>Done</option></select></div><div class="col-md-12"><label class="erp-form-label">Description</label><textarea class="erp-form-control" rows="3" placeholder=""></textarea></div></div>
      </div>
