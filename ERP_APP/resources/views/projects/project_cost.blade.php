...
<head>
  ...
  <title>Project Cost Tracking — NEXUS ERP</title>
...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">Project Cost Tracking</span>
  </div>
...
<div class="page-header">
  ...
  <div class="d-flex gap-2">
    ...
    <button class="btn-erp btn-primary" data-bs-toggle="modal" data-bs-target="#modalProjectCost"><i class="bi bi-plus-lg"></i> Log Cost</button>
  </div>
</div>
...
<div class="erp-card">
  <div class="table-toolbar">
    ...
    <select class="erp-form-control" style="width:140px"><option>All Status</option><option>On Budget</option><option>Over Budget</option><option>Under Budget</option></select>
  </div>
  <div class="erp-table-wrap">
    <table class="erp-table" id="tbl-main">
      <thead><tr><th>Project</th><th>Budget</th><th>Spent</th><th>Remaining</th><th>% Used</th><th>Variance</th><th>Status</th><th>Actions</th></tr></thead>
      <tbody><tr><td>ERP v2 Implementation</td><td>$120,000</td><td>$85,400</td><td>$34,600</td><td>71%</td><td>+$0</td><td><span class="badge-status badge-pending">On Budget</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalProjectCost" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Cost" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>Mobile App Dev</td><td>$45,000</td><td>$48,200</td><td>$0</td><td>107%</td><td>-$3,200</td><td><span class="badge-status badge-inactive">Overdue</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalProjectCost" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Cost" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>Infrastructure Upgrade</td><td>$80,000</td><td>$52,100</td><td>$27,900</td><td>65%</td><td>+$27,900</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalProjectCost" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Cost" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>CRM Integration</td><td>$30,000</td><td>$29,800</td><td>$200</td><td>99%</td><td>+$200</td><td><span class="badge-status badge-pending">On Budget</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalProjectCost" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Cost" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr></tbody>
    </table>
  </div>
...
<div class="row g-3"><div class="col-md-6"><label class="erp-form-label">Project</label><input class="erp-form-control" type="text" placeholder="Project name"/></div><div class="col-md-6"><label class="erp-form-label">Cost Category</label><select class="erp-form-control"><option>Labor</option><option>Material</option><option>Overhead</option><option>Software License</option></select></div><div class="col-md-4"><label class="erp-form-label">Amount ($)</label><input class="erp-form-control" type="number" placeholder=""/></div><div class="col-md-4"><label class="erp-form-label">Date Incurred</label><input class="erp-form-control" type="date" placeholder=""/></div><div class="col-md-4"><label class="erp-form-label">Approved By</label><select class="erp-form-control"><option>Adam K.</option><option>Sara L.</option></select></div><div class="col-md-12"><label class="erp-form-label">Description</label><textarea class="erp-form-control" rows="2" placeholder=""></textarea></div></div>
      </div>
