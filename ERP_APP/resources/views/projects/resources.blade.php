...
<head>
  ...
  <title>Resource Allocation — NEXUS ERP</title>
...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">Resource Allocation</span>
  </div>
...
<div class="page-header">
  ...
  <div class="d-flex gap-2">
    ...
    <button class="btn-erp btn-primary" data-bs-toggle="modal" data-bs-target="#modalResource"><i class="bi bi-plus-lg"></i> Assign Resource</button>
  </div>
</div>
...
<div class="erp-card">
  <div class="table-toolbar">
    ...
    <select class="erp-form-control" style="width:140px"><option>All Status</option><option>ERP v2</option><option>Mobile App</option><option>Infrastructure</option></select>
  </div>
  <div class="erp-table-wrap">
    <table class="erp-table" id="tbl-main">
      <thead><tr><th>Employee</th><th>Role</th><th>Project</th><th>Allocation %</th><th>From</th><th>To</th><th>Availability</th><th>Actions</th></tr></thead>
      <tbody><tr><td>Adam Khan</td><td>Lead Developer</td><td>ERP v2</td><td>80%</td><td>2025-01-01</td><td>2025-03-31</td><td>20% free</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalResource" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Assign Resource" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>Sara Lee</td><td>Project Manager</td><td>ERP v2</td><td>50%</td><td>2025-01-01</td><td>2025-06-30</td><td>50% free</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalResource" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Assign Resource" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>James R.</td><td>Tester</td><td>Mobile App</td><td>100%</td><td>2025-01-10</td><td>2025-02-28</td><td>Fully booked</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalResource" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Assign Resource" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>Maya P.</td><td>Business Analyst</td><td>Infrastructure</td><td>60%</td><td>2025-01-15</td><td>2025-04-30</td><td>40% free</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalResource" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Assign Resource" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr></tbody>
    </table>
  </div>
...
<div class="row g-3"><div class="col-md-6"><label class="erp-form-label">Employee</label><select class="erp-form-control"><option>Adam Khan</option><option>Sara Lee</option><option>James R.</option></select></div><div class="col-md-6"><label class="erp-form-label">Project</label><input class="erp-form-control" type="text" placeholder="Project name"/></div><div class="col-md-4"><label class="erp-form-label">Allocation (%)</label><input class="erp-form-control" type="number" placeholder=""/></div><div class="col-md-4"><label class="erp-form-label">From Date</label><input class="erp-form-control" type="date" placeholder=""/></div><div class="col-md-4"><label class="erp-form-label">To Date</label><input class="erp-form-control" type="date" placeholder=""/></div><div class="col-md-6"><label class="erp-form-label">Role on Project</label><input class="erp-form-control" type="text" placeholder="e.g. Lead Developer"/></div></div>
      </div>
