...
<head>
  ...
  <title>Defect Tracking — NEXUS ERP</title>
...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">Defect Tracking</span>
  </div>
...
<div class="erp-card">
  <div class="table-toolbar">
    ...
    <select class="erp-form-control" style="width:140px"><option>All Status</option><option>Open</option><option>In Review</option><option>Resolved</option></select>
  </div>
  <div class="erp-table-wrap">
    <table class="erp-table" id="tbl-main">
      <thead><tr><th>Defect #</th><th>Product</th><th>Batch/Lot</th><th>Defect Type</th><th>Severity</th><th>Raised By</th><th>Status</th><th>Actions</th></tr></thead>
      <tbody><tr><td>DEF-2025-018</td><td>Assembled PCB Board</td><td>LOT-2024-009</td><td>Solder Bridge</td><td>High</td><td>Kamal I.</td><td><span class="badge-status badge-pending">In Review</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDefect" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Defect" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>DEF-2025-017</td><td>Battery Pack 18V</td><td>LOT-2024-009</td><td>Capacity Drop</td><td>Critical</td><td>Nadia Q.</td><td><span class="badge-status badge-pending">Open</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDefect" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Defect" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>DEF-2025-015</td><td>Steel Bracket 10mm</td><td>LOT-2023-044</td><td>Dimensional Error</td><td>Medium</td><td>James R.</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDefect" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Defect" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>DEF-2025-012</td><td>HP ProBook 450</td><td>—</td><td>Screen Flicker</td><td>High</td><td>Adam K.</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDefect" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Defect" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr></tbody>
    </table>
  </div>
...
<div class="row g-3"><div class="col-md-6"><label class="erp-form-label">Product</label><select class="erp-form-control"><option>Assembled PCB Board</option><option>Battery Pack 18V</option><option>Steel Bracket</option></select></div><div class="col-md-6"><label class="erp-form-label">Batch / Lot</label><input class="erp-form-control" type="text" placeholder="LOT-XXXX-XXX"/></div><div class="col-md-6"><label class="erp-form-label">Defect Type</label><input class="erp-form-control" type="text" placeholder="e.g. Dimensional Error"/></div><div class="col-md-3"><label class="erp-form-label">Severity</label><select class="erp-form-control"><option>Low</option><option>Medium</option><option>High</option><option>Critical</option></select></div><div class="col-md-3"><label class="erp-form-label">Qty Affected</label><input class="erp-form-control" type="number" placeholder=""/></div><div class="col-md-12"><label class="erp-form-label">Description / Root Cause</label><textarea class="erp-form-control" rows="3" placeholder=""></textarea></div></div>
      </div>
