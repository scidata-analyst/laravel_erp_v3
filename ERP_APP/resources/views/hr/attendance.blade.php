...
<head>
  ...
  <title>Attendance & Leave — NEXUS ERP</title>
...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">Attendance & Leave</span>
  </div>
...
<div class="page-header">
  ...
  <div class="d-flex gap-2">
    ...
    <button class="btn-erp btn-primary" data-bs-toggle="modal" data-bs-target="#modalAttendance"><i class="bi bi-plus-lg"></i> Log Attendance</button>
  </div>
</div>
...
<div class="erp-card">
  <div class="table-toolbar">
    ...
    <select class="erp-form-control" style="width:140px"><option>All Status</option><option>Present</option><option>Absent</option><option>Leave</option><option>Half Day</option></select>
  </div>
  <div class="erp-table-wrap">
    <table class="erp-table" id="tbl-main">
      <thead><tr><th>Employee</th><th>Date</th><th>Check In</th><th>Check Out</th><th>Hours</th><th>Leave Type</th><th>Status</th><th>Actions</th></tr></thead>
      <tbody><tr><td>Adam Khan</td><td>2025-01-12</td><td>09:02</td><td>18:05</td><td>9h 3m</td><td>—</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalAttendance" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Attendance" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>Sara Lee</td><td>2025-01-12</td><td>08:55</td><td>17:58</td><td>9h 3m</td><td>—</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalAttendance" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Attendance" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>James R.</td><td>2025-01-12</td><td>—</td><td>—</td><td>—</td><td>Annual Leave</td><td><span class="badge-status badge-pending">Pending</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalAttendance" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Attendance" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>Maya P.</td><td>2025-01-12</td><td>09:30</td><td>14:00</td><td>4h 30m</td><td>—</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalAttendance" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Attendance" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr></tbody>
    </table>
  </div>
...
<div class="row g-3"><div class="col-md-6"><label class="erp-form-label">Employee</label><select class="erp-form-control"><option>Adam Khan</option><option>Sara Lee</option><option>James R.</option></select></div><div class="col-md-6"><label class="erp-form-label">Date</label><input class="erp-form-control" type="date" placeholder=""/></div><div class="col-md-3"><label class="erp-form-label">Check In</label><input class="erp-form-control" type="time" placeholder=""/></div><div class="col-md-3"><label class="erp-form-label">Check Out</label><input class="erp-form-control" type="time" placeholder=""/></div><div class="col-md-6"><label class="erp-form-label">Status</label><select class="erp-form-control"><option>Present</option><option>Absent</option><option>Leave</option><option>Half Day</option></select></div><div class="col-md-12"><label class="erp-form-label">Leave Type (if applicable)</label><select class="erp-form-control"><option>—</option><option>Annual Leave</option><option>Sick Leave</option><option>Maternity</option></select></div></div>
      </div>
