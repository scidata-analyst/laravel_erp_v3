...
<head>
  ...
  <title>Performance Tracking — NEXUS ERP</title>
...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">Performance Tracking</span>
  </div>
...
<div class="page-header">
  ...
  <div class="d-flex gap-2">
    ...
    <button class="btn-erp btn-primary" data-bs-toggle="modal" data-bs-target="#modalPerformance"><i class="bi bi-plus-lg"></i> New Review</button>
  </div>
</div>
...
<div class="erp-card">
  <div class="table-toolbar">
    ...
    <select class="erp-form-control" style="width:140px"><option>All Status</option><option>Excellent</option><option>Good</option><option>Satisfactory</option><option>Poor</option></select>
  </div>
  <div class="erp-table-wrap">
    <table class="erp-table" id="tbl-main">
      <thead><tr><th>Employee</th><th>Department</th><th>Review Period</th><th>KPI Score</th><th>Goal Achievement</th><th>Rating</th><th>Status</th><th>Actions</th></tr></thead>
      <tbody><tr><td>Adam Khan</td><td>IT</td><td>Q4 2024</td><td>92/100</td><td>95%</td><td>Excellent</td><td><span class="badge-status badge-active">Completed</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalPerformance" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Review" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>Sara Lee</td><td>Sales</td><td>Q4 2024</td><td>88/100</td><td>102%</td><td>Excellent</td><td><span class="badge-status badge-active">Completed</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalPerformance" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Review" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>James R.</td><td>Warehouse</td><td>Q4 2024</td><td>74/100</td><td>78%</td><td>Satisfactory</td><td><span class="badge-status badge-pending">In Review</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalPerformance" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Review" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>Maya P.</td><td>Finance</td><td>Q4 2024</td><td>85/100</td><td>88%</td><td>Good</td><td><span class="badge-status badge-active">Completed</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalPerformance" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Review" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr></tbody>
    </table>
  </div>
...
<div class="row g-3"><div class="col-md-6"><label class="erp-form-label">Employee</label><select class="erp-form-control"><option>Adam Khan</option><option>Sara Lee</option><option>James R.</option></select></div><div class="col-md-6"><label class="erp-form-label">Review Period</label><select class="erp-form-control"><option>Q1 2025</option><option>Q4 2024</option><option>Annual 2024</option></select></div><div class="col-md-4"><label class="erp-form-label">KPI Score (/ 100)</label><input class="erp-form-control" type="number" placeholder=""/></div><div class="col-md-4"><label class="erp-form-label">Goal Achievement (%)</label><input class="erp-form-control" type="number" placeholder=""/></div><div class="col-md-4"><label class="erp-form-label">Overall Rating</label><select class="erp-form-control"><option>Excellent</option><option>Good</option><option>Satisfactory</option><option>Poor</option></select></div><div class="col-md-12"><label class="erp-form-label">Reviewer Comments</label><textarea class="erp-form-control" rows="3" placeholder=""></textarea></div></div>
      </div>
