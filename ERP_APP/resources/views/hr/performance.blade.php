      ...
      <div class="modal-content"
        ...
        <div class="modal-body">
          <div class="row g-3">
            ...
            <div class="col-md-6"><label class="erp-form-label">Review Period</label><select class="erp-form-control">
                <option>Q1 2025</option>
                <option>Q4 2024</option>
                <option>Annual 2024</option>
              </select></div>
            <div class="col-md-4"><label class="erp-form-label">KPI Score (/ 100)</label><input class="erp-form-control"
                type="number" placeholder="" /></div>
            <div class="col-md-4"><label class="erp-form-label">Goal Achievement (%)</label><input
                class="erp-form-control" type="number" placeholder="" /></div>
            <div class="col-md-4"><label class="erp-form-label">Overall Rating</label><select class="erp-form-control">
                <option>Excellent</option>
                <option>Good</option>
                <option>Satisfactory</option>
                <option>Poor</option>
              </select></div>
            <div class="col-md-12"><label class="erp-form-label">Reviewer Comments</label><textarea
