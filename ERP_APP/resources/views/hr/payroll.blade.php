...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">Payroll</span>
  </div>
...
<div class="row g-3 mb-3">
  <div class="col-md-3"><div class="kpi-tile blue"><div class="kpi-icon blue"><i class="bi bi-wallet2"></i></div><div class="kpi-value">$182K</div><div class="kpi-label">Total Payroll (Jan)</div></div></div>
  <div class="col-md-3"><div class="kpi-tile green"><div class="kpi-icon green"><i class="bi bi-check-circle"></i></div><div class="kpi-value">42</div><div class="kpi-label">Processed</div></div></div>
  <div class="col-md-3"><div class="kpi-tile yellow"><div class="kpi-icon yellow"><i class="bi bi-hourglass-split"></i></div><div class="kpi-value">3</div><div class="kpi-label">Pending</div></div></div>
  <div class="col-md-3"><div class="kpi-tile red"><div class="kpi-icon red"><i class="bi bi-x-circle"></i></div><div class="kpi-value">0</div><div class="kpi-label">Failed</div></div></div>
</div>
<div class="erp-card">
  <div class="table-toolbar">
    ...
    <select class="erp-form-control" style="width:150px"><option>January 2025</option><option>December 2024</option></select>
  </div>
  <div class="erp-table-wrap">
    <table class="erp-table" id="tbl-payroll">
      <thead><tr><th>Employee</th><th>Designation</th><th>Basic</th><th>Allowances</th><th>Deductions</th><th>Net Pay</th><th>Status</th><th>Actions</th></tr></thead>
      <tbody>
        <tr><td>Adam Khan</td><td>IT Manager</td><td>$6,500</td><td>$800</td><td>$650</td><td>$6,650</td><td><span class="badge-status badge-active">Paid</span></td><td><button class="btn-erp btn-outline btn-xs"><i class="bi bi-file-earmark-text"></i> Slip</button></td></tr>
        <tr><td>Sara Lee</td><td>Sales Manager</td><td>$5,800</td><td>$600</td><td>$580</td><td>$5,820</td><td><span class="badge-status badge-active">Paid</span></td><td><button class="btn-erp btn-outline btn-xs"><i class="bi bi-file-earmark-text"></i> Slip</button></td></tr>
        <tr><td>James R.</td><td>Warehouse Staff</td><td>$3,200</td><td>$200</td><td>$320</td><td>$3,080</td><td><span class="badge-status badge-pending">Pending</span></td><td><button class="btn-erp btn-success btn-xs btn-process-payment">Process</button></td></tr>
      </tbody>
    </table>
  </div>
</div>
