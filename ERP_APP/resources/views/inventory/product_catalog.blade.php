...
<head>
  ...
  <title>Product Catalog — NEXUS ERP</title>
...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">Product Catalog</span>
  </div>
...
<div class="erp-card">
  <div class="table-toolbar">
    ...
    <select class="erp-form-control" style="width:140px"><option>All Status</option><option>Electronics</option><option>Hardware</option><option>Apparel</option><option>Furniture</option></select>
  </div>
  <div class="erp-table-wrap">
    <table class="erp-table" id="tbl-main">
      ...
      <tbody><tr><td>SKU-0021</td><td>HP ProBook 450 G9</td><td>Electronics</td><td>$849.00</td><td>142</td><td>WH-A</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalProduct" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Product" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>SKU-0044</td><td>Logitech MX Master 3</td><td>Electronics</td><td>$99.00</td><td>58</td><td>WH-B</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalProduct" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Product" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>SKU-0071</td><td>Steel Bracket 10mm</td><td>Hardware</td><td>$4.50</td><td>12</td><td>WH-A</td><td><span class="badge-status badge-pending">Low Stock</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalProduct" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Product" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>SKU-0098</td><td>Office Chair Pro</td><td>Furniture</td><td>$320.00</td><td>0</td><td>—</td><td><span class="badge-status badge-inactive">Out of Stock</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalProduct" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Product" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr></tbody>
    </table>
  </div>
...
<div class="row g-3"><div class="col-md-8"><label class="erp-form-label">Product Name</label><input class="erp-form-control" type="text" placeholder="Product name"/></div><div class="col-md-4"><label class="erp-form-label">SKU</label><input class="erp-form-control" type="text" placeholder="SKU-XXXX"/></div><div class="col-md-6"><label class="erp-form-label">Category</label><select class="erp-form-control"><option>Electronics</option><option>Hardware</option><option>Apparel</option><option>Furniture</option></select></div><div class="col-md-3"><label class="erp-form-label">Unit Price ($)</label><input class="erp-form-control" type="number" placeholder="0.00"/></div><div class="col-md-3"><label class="erp-form-label">Cost Price ($)</label><input class="erp-form-control" type="number" placeholder="0.00"/></div><div class="col-md-6"><label class="erp-form-label">Warehouse</label><select class="erp-form-control"><option>WH-A</option><option>WH-B</option><option>WH-C</option></select></div><div class="col-md-4"><label class="erp-form-label">Reorder Level</label><input class="erp-form-control" type="number" placeholder="10"/></div><div class="col-md-4"><label class="erp-form-label">Valuation Method</label><select class="erp-form-control"><option>FIFO</option><option>LIFO</option><option>Average Cost</option></select></div><div class="col-md-12"><label class="erp-form-label">Description</label><textarea class="erp-form-control" rows="2" placeholder="Product description…"></textarea></div></div>
      </div>
