...
<head>
  ...
  <title>Batch / Expiry Tracking — NEXUS ERP</title>
...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">Batch / Expiry Tracking</span>
  </div>
...
<div class="erp-card">
  <div class="table-toolbar">
    ...
    <select class="erp-form-control" style="width:140px"><option>All Status</option><option>Expiring Soon</option><option>Expired</option></select>
  </div>
  <div class="erp-table-wrap">
    <table class="erp-table" id="tbl-main">
      ...
      <tbody><tr><td>LOT-2024-001</td><td>SN-88421</td><td>Paracetamol 500mg</td><td>500</td><td>2024-01-01</td><td>2027-01-01</td><td><span class="badge-status badge-active">Active</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalBatch" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Batch" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>LOT-2024-009</td><td>SN-72310</td><td>Battery Pack 18V</td><td>120</td><td>2023-06-15</td><td>2025-06-15</td><td><span class="badge-status badge-pending">Pending</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalBatch" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Batch" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>LOT-2023-044</td><td>SN-11902</td><td>Lubricant WD-40</td><td>80</td><td>2023-01-01</td><td>2024-12-31</td><td><span class="badge-status badge-inactive">Expired</span></td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalBatch" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Batch" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr></tbody>
    </table>
  </div>
...
<div class="row g-3"><div class="col-md-6"><label class="erp-form-label">Product</label><select class="erp-form-control"><option>Paracetamol 500mg</option><option>Battery Pack</option></select></div><div class="col-md-6"><label class="erp-form-label">Batch / Lot #</label><input class="erp-form-control" type="text" placeholder="LOT-XXXX-XXX"/></div><div class="col-md-6"><label class="erp-form-label">Serial Number</label><input class="erp-form-control" type="text" placeholder="SN-XXXXX"/></div><div class="col-md-6"><label class="erp-form-label">Quantity</label><input class="erp-form-control" type="number" placeholder=""/></div><div class="col-md-6"><label class="erp-form-label">Manufacturing Date</label><input class="erp-form-control" type="date" placeholder=""/></div><div class="col-md-6"><label class="erp-form-label">Expiry Date</label><input class="erp-form-control" type="date" placeholder=""/></div></div>
      </div>
