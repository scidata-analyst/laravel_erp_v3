...
<head>
  ...
  <title>Stock Valuation — NEXUS ERP</title>
...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">Stock Valuation</span>
  </div>
...
<div class="page-header">
  ...
  <div class="d-flex gap-2">
    <select class="erp-form-control" style="width:150px"><option>FIFO</option><option>LIFO</option><option>Average Cost</option></select>
    <button class="btn-erp btn-outline btn-export"><i class="bi bi-download"></i> Export</button>
  </div>
</div>
<div class="row g-3 mb-3">
  <div class="col-md-4"><div class="kpi-tile blue"><div class="kpi-icon blue"><i class="bi bi-currency-dollar"></i></div><div class="kpi-value">$1.24M</div><div class="kpi-label">Total Stock Value (FIFO)</div></div></div>
  <div class="col-md-4"><div class="kpi-tile yellow"><div class="kpi-icon yellow"><i class="bi bi-stack"></i></div><div class="kpi-value">14,230</div><div class="kpi-label">Total Units</div></div></div>
  <div class="col-md-4"><div class="kpi-tile green"><div class="kpi-icon green"><i class="bi bi-graph-up"></i></div><div class="kpi-value">$87.24</div><div class="kpi-label">Avg Unit Value</div></div></div>
</div>
<div class="erp-card">
  <div class="erp-table-wrap">
    <table class="erp-table">
      ...
      <tbody>
        <tr><td>HP ProBook 450 G9</td><td>SKU-0021</td><td>142</td><td>FIFO</td><td>$720.00</td><td>$102,240.00</td><td>2025-01-12</td></tr>
        <tr><td>Logitech MX Master 3</td><td>SKU-0044</td><td>58</td><td>FIFO</td><td>$75.00</td><td>$4,350.00</td><td>2025-01-11</td></tr>
        <tr><td>Steel Bracket 10mm</td><td>SKU-0071</td><td>12</td><td>Avg Cost</td><td>$3.20</td><td>$38.40</td><td>2025-01-10</td></tr>
      </tbody>
    </table>
  </div>
</div>
