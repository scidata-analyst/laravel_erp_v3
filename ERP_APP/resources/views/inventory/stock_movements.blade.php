...
<head>
  ...
  <title>Stock In / Out — NEXUS ERP</title>
...
<header id="header">
  ...
  <div class="breadcrumb-trail">
    ...
    <span class="sep">/</span>
    <span id="breadcrumb-current">Stock In / Out</span>
  </div>
...
<div class="row g-3 mb-3">
      <div class="col-md-4"><div class="kpi-tile green"><div class="kpi-icon green"><i class="bi bi-box-arrow-in-down"></i></div><div class="kpi-value">+4,820</div><div class="kpi-label">Stock In (This Month)</div></div></div>
      <div class="col-md-4"><div class="kpi-tile red"><div class="kpi-icon red"><i class="bi bi-box-arrow-up-right"></i></div><div class="kpi-value">-3,142</div><div class="kpi-label">Stock Out (This Month)</div></div></div>
      <div class="col-md-4"><div class="kpi-tile blue"><div class="kpi-icon blue"><i class="bi bi-boxes"></i></div><div class="kpi-value">14,230</div><div class="kpi-label">Net Current Stock</div></div></div>
    </div>
<div class="erp-card">
  <div class="table-toolbar">
    ...
    <select class="erp-form-control" style="width:140px"><option>All Status</option><option>Stock In</option><option>Stock Out</option><option>Transfer</option></select>
  </div>
  <div class="erp-table-wrap">
    <table class="erp-table" id="tbl-main">
      ...
      <tbody><tr><td>MV-2024-001</td><td>2025-01-12</td><td>HP ProBook 450</td><td><span class="badge-status badge-info">Stock In</span></td><td>+50</td><td>WH-A</td><td>Purchase Recv.</td><td>James R.</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalStockMove" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Movement" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>MV-2024-002</td><td>2025-01-11</td><td>Office Chair Pro</td><td><span class="badge-status badge-info">Stock Out</span></td><td>-10</td><td>WH-B</td><td>Sales Order</td><td>Sara L.</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalStockMove" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Movement" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr>
<tr><td>MV-2024-003</td><td>2025-01-10</td><td>Steel Bracket 10mm</td><td><span class="badge-status badge-info">Transfer</span></td><td>200</td><td>WH-A → WH-B</td><td>Rebalancing</td><td>Adam K.</td><td><div class="d-flex gap-1"><button class="btn-erp btn-outline btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalStockMove" title="Edit"><i class="bi bi-pencil"></i></button><button class="btn-erp btn-danger btn-xs btn-icon" data-bs-toggle="modal" data-bs-target="#modalDelete" data-delete-label="Movement" title="Delete"><i class="bi bi-trash"></i></button></div></td></tr></tbody>
    </table>
  </div>
...
<div class="row g-3"><div class="col-md-6"><label class="erp-form-label">Product</label><select class="erp-form-control"><option>HP ProBook 450</option><option>Office Chair Pro</option></select></div><div class="col-md-6"><label class="erp-form-label">Movement Type</label><select class="erp-form-control"><option>Stock In</option><option>Stock Out</option><option>Transfer</option></select></div><div class="col-md-4"><label class="erp-form-label">Quantity</label><input class="erp-form-control" type="number" placeholder=""/></div><div class="col-md-4"><label class="erp-form-label">From Warehouse</label><select class="erp-form-control"><option>WH-A</option><option>WH-B</option></select></div><div class="col-md-4"><label class="erp-form-label">To Warehouse</label><select class="erp-form-control"><option>—</option><option>WH-A</option><option>WH-B</option></select></div><div class="col-md-12"><label class="erp-form-label">Reason / Notes</label><textarea class="erp-form-control" rows="2" placeholder=""></textarea></div></div>
      </div>
