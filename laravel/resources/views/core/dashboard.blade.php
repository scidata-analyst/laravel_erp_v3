        ...
        <div class="sidebar-nav">
            ...
            <div class="nav-item">
                ...
                <div class="nav-submenu">
                    ...
                    <a class="nav-submenu-link" href="{{ route('roles') }}" data-page="roles"><span>Roles &amp;
                            Permissions</span></a>
                </div>
            </div>
            ...
            <div class="nav-item">
                ...
                <div class="nav-submenu">
                    <a class="nav-submenu-link" href="{{ route('product_catalog') }}" data-page="products"><span>Product
                            Catalog</span></a>
                    <a class="nav-submenu-link" href="{{ route('stock_movements') }}"
                        data-page="stock-movements"><span>Stock
                            In/Out</span></a>
                    <a class="nav-submenu-link" href="{{ route('batch_tracking') }}"
                        data-page="batch-tracking"><span>Batch
                            /
                            Expiry</span></a>
                    <a class="nav-submenu-link" href="{{ route('stock_valuation') }}"
            ...
            <div class="nav-item">
                ...
                <div class="nav-submenu">
                    <a class="nav-submenu-link" href="{{ route('suppliers') }}"
                        data-page="suppliers"><span>Suppliers</span></a>
                    <a class="nav-submenu-link" href="{{ route('purchase_orders') }}"
                        data-page="purchase-orders"><span>Purchase
                            Orders</span></a>
                    <a class="nav-submenu-link" href="{{ route('grn') }}" data-page="grn"><span>GRN</span></a>
                    <a class="nav-submenu-link" href="{{ route('supplier_payments') }}"
            ...
            <div class="nav-item">
                ...
                <div class="nav-submenu">
                    <a class="nav-submenu-link" href="{{ route('customers') }}"
                        data-page="customers"><span>Customers</span></a>
                    <a class="nav-submenu-link" href="{{ route('sales_orders') }}" data-page="sales-orders"><span>Sales
                            Orders</span></a>
                    <a class="nav-submenu-link" href="{{ route('invoices') }}"
                        data-page="invoices"><span>Invoices</span></a>
                    <a class="nav-submenu-link" href="{{ route('promotions') }}" data-page="promotions"><span>Discounts
                            &amp;
                            Promos</span></a>
                </div>
            </div>
            ...
            <div class="nav-item">
                ...
                <div class="nav-submenu">
                    ...
                    <a class="nav-submenu-link" href="{{ route('tax') }}" data-page="tax"><span>Tax &amp;
                            Compliance</span></a>
                    <a class="nav-submenu-link" href="{{ route('fin_reports') }}"
                        data-page="fin-reports"><span>Financial
                            Reports</span></a>
                </div>
            </div>
            ...
            <div class="nav-item">
                ...
                <div class="nav-submenu">
                    <a class="nav-submenu-link" href="{{ route('employees') }}"
                        data-page="employees"><span>Employees</span></a>
                    <a class="nav-submenu-link" href="{{ route('attendance') }}" data-page="attendance"><span>Attendance
                            &amp;
                            Leave</span></a>
                    <a class="nav-submenu-link" href="{{ route('payroll') }}"
                        data-page="payroll"><span>Payroll</span></a>
                    <a class="nav-submenu-link" href="{{ route('performance') }}"
            ...
            <div class="nav-item">
                ...
                <div class="nav-submenu">
                    <a class="nav-submenu-link" href="{{ route('bom') }}" data-page="bom"><span>Bill of
                            Materials</span></a>
                    <a class="nav-submenu-link" href="{{ route('work_orders') }}" data-page="work-orders"><span>Work
                            Orders</span></a>
                    <a class="nav-submenu-link" href="{{ route('machine_labor') }}"
                        data-page="machine-labor"><span>Machine
                            &amp;
                            Labor</span></a>
                </div>
            </div>
            ...
            <div class="nav-item">
                ...
                <div class="nav-submenu">
                    <a class="nav-submenu-link" href="{{ route('leads') }}" data-page="leads"><span>Leads &amp;
                            Opportunities</span></a>
                    <a class="nav-submenu-link" href="{{ route('support') }}" data-page="support"><span>Customer
                            Support</span></a>
                    <a class="nav-submenu-link" href="{{ route('interactions') }}"
            ...
            <div class="nav-item">
                ...
                <div class="nav-submenu">
                    <a class="nav-submenu-link" href="{{ route('tasks') }}" data-page="tasks"><span>Tasks &amp;
                            Milestones</span></a>
                    <a class="nav-submenu-link" href="{{ route('resources') }}" data-page="resources"><span>Resource
                            Allocation</span></a>
                    <a class="nav-submenu-link" href="{{ route('project_cost') }}" data-page="project-cost"><span>Cost
                            Tracking</span></a>
                </div>
            </div>
            ...
            <div class="nav-item">
                ...
                <div class="nav-submenu">
                    <a class="nav-submenu-link" href="{{ route('warehouses') }}"
                        data-page="warehouses"><span>Multi-Warehouse</span></a>
                    <a class="nav-submenu-link" href="{{ route('shipments') }}"
                        data-page="shipments"><span>Shipments</span></a>
                    <a class="nav-submenu-link" href="{{ route('routes') }}" data-page="routes"><span>Routes &amp;
                            Delivery</span></a>
                </div>
            </div>
            ...
            <div class="nav-item">
                ...
                <div class="nav-submenu">
                    <a class="nav-submenu-link" href="{{ route('qc_checklists') }}" data-page="qc-checklists"><span>QC
                            Checklists</span></a>
                    <a class="nav-submenu-link" href="{{ route('defects') }}" data-page="defects"><span>Defect
                            Tracking</span></a>
                    <a class="nav-submenu-link" href="{{ route('compliance') }}" data-page="compliance"><span>Compliance
                            Reports</span></a>
                </div>
            </div>
            ...
            <div class="nav-item">
                ...
                <div class="nav-submenu">
                    <a class="nav-submenu-link" href="{{ route('online_channels') }}"
                        data-page="online-channels"><span>Sales
                            Channels</span></a>
                    <a class="nav-submenu-link" href="{{ route('pos') }}" data-page="pos"><span>POS Terminals</span></a>
                    <a class="nav-submenu-link" href="{{ route('inv_sync') }}" data-page="inv-sync"><span>Inventory
                            Sync</span></a>
                </div>
            </div>
            ...
            <div class="nav-item">
                ...
                <div class="nav-submenu">
                    <a class="nav-submenu-link" href="{{ route('custom_reports') }}"
                        data-page="custom-reports"><span>Custom
                            Reports</span></a>
                    <a class="nav-submenu-link" href="{{ route('forecasting') }}"
                        data-page="forecasting"><span>Forecasting</span></a>
                    <a class="nav-submenu-link" href="{{ route('bi_dashboards') }}" data-page="bi-dashboards"><span>BI
                            Dashboards</span></a>
                </div>
            </div>
            ...
            <div class="nav-item">
                ...
                <div class="nav-submenu">
                    <a class="nav-submenu-link" href="{{ route('doc_library') }}" data-page="doc-library"><span>Document
                            Library</span></a>
                    <a class="nav-submenu-link" href="{{ route('doc_versions') }}"
                        data-page="doc-versions"><span>Version
                            Control</span></a>
                </div>
            </div>
    ...
    <main id="main">
                ...
                <div class="erp-card h-100">
                    ...
                    <div class="donut-wrap mb-3">
                        <svg class="donut-chart" viewBox="0 0 42 42">
                            <circle cx="21" cy="21" r="15.915" fill="transparent" stroke="var(--bg-elevated)"
                                stroke-width="5" />
                            <circle cx="21" cy="21" r="15.915" fill="transparent" stroke="var(--accent)"
                                stroke-width="5" stroke-dasharray="35 65" stroke-dashoffset="25" />
                            <circle cx="21" cy="21" r="15.915" fill="transparent" stroke="var(--accent-2)"
                                stroke-width="5" stroke-dasharray="25 75" stroke-dashoffset="-10" />
                            <circle cx="21" cy="21" r="15.915" fill="transparent" stroke="var(--accent-4)"
                                stroke-width="5" stroke-dasharray="20 80" stroke-dashoffset="-35" />
                            <circle cx="21" cy="21" r="15.915" fill="transparent" stroke="var(--accent-5)"
                                stroke-width="5" stroke-dasharray="15 85" stroke-dashoffset="-55" />
                            <circle cx="21" cy="21" r="15.915" fill="transparent" stroke="var(--accent-3)"
                                stroke-width="5" stroke-dasharray="5 95" stroke-dashoffset="-70" />
                        </svg>
        ...
        <div class="row g-3">
            <div class="col-lg-4">
                <div class="erp-card">
                    <div class="card-header-bar">
                        <div class="card-title">Recent Activity</div><a href="#" class="btn-erp btn-outline btn-sm">View
                            All</a>
                    </div>
                    <div class="timeline">
                        <div class="tl-item">
            ...
            <div class="col-lg-4">
                <div class="erp-card">
                    ...
                    <div class="row g-2">
                        <div class="col-4"><a class="quick-action" href="{{ route('purchase_orders') }}">
                                <div class="qa-icon">🛒</div>
                                <div class="qa-label">New PO</div>
                            </a></div>
                        <div class="col-4"><a class="quick-action" href="{{ route('invoices') }}">
                                <div class="qa-icon">🧾</div>
                                <div class="qa-label">Invoice</div>
                            </a></div>
                        <div class="col-4"><a class="quick-action" href="{{ route('employees') }}">
                                <div class="qa-icon">👤</div>
                                <div class="qa-label">Add Employee</div>
                            </a></div>
                        <div class="col-4"><a class="quick-action" href="{{ route('grn') }}">
                                <div class="qa-icon">📦</div>
                                <div class="qa-label">New GRN</div>
                            </a></div>
                        <div class="col-4"><a class="quick-action" href="{{ route('payroll') }}">
                                <div class="qa-icon">💵</div>
                                <div class="qa-label">Run Payroll</div>
                            </a></div>
                        <div class="col-4"><a class="quick-action" href="{{ route('custom_reports') }}">
                                <div class="qa-icon">📊</div>
            ...
            <div class="modal-content"
                ...
                <div class="modal-header" style="border-color:var(--border)">
                    <h5 class="modal-title" style="color:var(--accent-3)"><i
                            class="bi bi-exclamation-triangle me-2"></i>Confirm
                        Delete</h5>
