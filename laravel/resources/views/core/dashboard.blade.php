  ...
  <nav id="sidebar">
    ...
    <div class="sidebar-nav">
        ...
        <div class="nav-submenu">
          ...
          <a class="nav-submenu-link" href="{{ route('stock_movements') }}"
            data-page="stock-movements"><span>Stock
              In/Out</span></a>
          <a class="nav-submenu-link" href="{{ route('batch_tracking') }}" data-page="batch-tracking"><span>Batch
              /
              Expiry</span></a>
      ...
      <div class="nav-item">
        ...
        <div class="nav-submenu">
          ...
          <a class="nav-submenu-link" href="{{ route('tax') }}" data-page="tax"><span>Tax &amp;
              Compliance</span></a>
          <a class="nav-submenu-link" href="{{ route('fin_reports') }}" data-page="fin-reports"><span>Financial
              Reports</span></a>
        </div>
      </div>
      ...
      <div class="nav-item">
        ...
        <div class="nav-submenu">
          ...
          <a class="nav-submenu-link" href="{{ route('work_orders') }}" data-page="work-orders"><span>Work
              Orders</span></a>
          <a class="nav-submenu-link" href="{{ route('machine_labor') }}" data-page="machine-labor"><span>Machine
              &amp;
              Labor</span></a>
        </div>
      </div>
      ...
      <div class="nav-item">
        ...
        <div class="nav-submenu">
          <a class="nav-submenu-link" href="{{ route('custom_reports') }}" data-page="custom-reports"><span>Custom
              Reports</span></a>
      ...
      <div class="nav-item">
        ...
        <div class="nav-submenu">
          <a class="nav-submenu-link" href="{{ route('doc_library') }}" data-page="doc-library"><span>Document
              Library</span></a>
          <a class="nav-submenu-link" href="{{ route('doc_versions') }}" data-page="doc-versions"><span>Version
              Control</span></a>
        </div>
      </div>
