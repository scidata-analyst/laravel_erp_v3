...
class PosFactory extends Factory
{
    ...
    {
        return [
            'terminal_id' => $this->faker->unique()->numerify('POS-####'),
            'location' => $this->faker->randomElement(['Store Front', 'Warehouse', 'Branch Office', 'Pop-up Shop']),
            'assigned_cashier_id' => \App\Models\UsersRoles\User::factory(),
            'warehouse_id' => \App\Models\Logistics\Warehouses::factory(),
            'receipt_printer' => $this->faker->randomElement(['Printer A', 'Printer B', 'No Printer']),
